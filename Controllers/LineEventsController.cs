...
namespace WebHome.Controllers
{
    public class LineEventsController : SampleController<LiveDevice>
    {
        ...
        public async Task<ActionResult> GetProfile(String userId)
        {
            ...
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", Settings.Default.ChannelToken);
            HttpResponseMessage async = await client.GetAsync(string.Format("https://api.line.me/v2/bot/profile/{0}", userId));
