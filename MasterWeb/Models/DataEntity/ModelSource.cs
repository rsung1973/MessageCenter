...
{
    public class ModelSource<TEntity> : GenericManager<MessageCenterDataContext, TEntity>
        where TEntity : class,new()
    {
        ...
        public ModelSource(GenericManager<MessageCenterDataContext> manager) : base(manager) { }
        ...
        public MessageCenterDataContext GetDataContext()
        {
            return (MessageCenterDataContext)this._db;
        }
